...
object tailrecursion {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(100); 
  ...
  gcd(21, 14);System.out.println("""res1: Int = """ + $show(res$1));$skip(75); 
  
  //!tailrec
  def fact(x: Int):Int = if(x == 1) x else x * fact(x - 1);System.out.println("""fact: (x: Int)Int""");$skip(10); val res$2 = 
  fact(5);System.out.println("""res2: Int = """ + $show(res$2));$skip(167); 
  ...
  def factorial(x: Int):Int = {
  	...
  	iter(x, 1, 1)
  };System.out.println("""factorial: (x: Int)Int""");$skip(15); val res$3 = 
  factorial(5);System.out.println("""res3: Int = """ + $show(res$3));$skip(146); 
  ...
  def tailfactorial(x: Int) = {
  	...
  	loop(1, x)
  };System.out.println("""tailfactorial: (x: Int)Int""");$skip(22); val res$4 = 
  
  tailfactorial(5);System.out.println("""res4: Int = """ + $show(res$4))}
}
